...
def register_patron():
    ...
    data = {"name": name, "phone": phone, "location": location, "nationality": nationality,
            "messengerType": messengerType, "groupName": groupName}
...
def register_immigrant():
    ...
    data = {"name": name, "phone": phone, "location": location, "patronPhone": patronPhone, "nationality": nationality,
            "messengerType": messengerType, "groupName": groupName}
...
def post_events():
    ...
    nationality = val['nationality']
    groupName = val['groupName']
    data = {"event": eventData, "patronPhone": patronNumber, "location": location, "nationality": nationality,
            "messengerType": messengerType, "groupName": groupName}
    root = db.reference()
